...
export declare class StudentsService implements OnModuleInit {
    ...
    constructor(prisma: PrismaService, storageService: StorageService, billingService: BillingService);
    ...
    getStudentsBillingInfoBatch(studentIds: string[], tenantId: string, academicYearId?: string): Promise<Record<string, any>>;
    searchStudents(searchTerm?: string, classId?: string, sectionId?: string, academicYearId?: string, page?: number, limit?: number): Promise<{
        paidAmount: any;
        balanceDue: any;
        totalFees: any;
    ...
    getStudentDetails(studentId: string, academicYearId?: string): Promise<{
        paidAmount: number;
        balanceDue: number;
        totalFees: number;
    ...
    importStudentsBulk(studentRows: any[]): Promise<{
        totalRows: number;
        successCount: number;
        errors: string[];
    }>;
    ...
    updateStudent(studentId: string, data: any): Promise<{
        paidAmount: number;
        balanceDue: number;
        totalFees: number;
        pendingPercentage: number;
    ...
    bulkDeleteStudents(studentIds: string[], actorUserId: string): Promise<{
        success: boolean;
        count: number;
    }>;
}
