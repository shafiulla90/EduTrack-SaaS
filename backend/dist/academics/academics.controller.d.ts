...
export declare class AcademicsController {
    ...
    createYear(name: string, startDate: Date, endDate: Date, isActive: boolean): Promise<{
        id: string;
        isActive: boolean;
        name: string;
        tenantId: string;
    ...
    toggleYearActive(id: string): Promise<{
        id: string;
        isActive: boolean;
        name: string;
        tenantId: string;
    ...
    getClassSectionSubjects(classSectionId: string): Promise<({
        subject: {
            id: string;
            isActive: boolean;
            name: string;
    ...
    createTiming(periodNumber: number, startTime: string, endTime: string, isActive: boolean): Promise<{
        id: string;
        isActive: boolean;
        name: string;
        tenantId: string;
