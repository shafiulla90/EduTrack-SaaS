...
export declare class BillingService {
    ...
    private getTenantId;
    recalculatePaidAmount(oppId: string, tx?: any): Promise<number>;
    ...
    getAcademicYearOptions(): Promise<{
        label: string;
        value: string;
    }[]>;
    getClassOptions(): Promise<{
        label: string;
        value: string;
    }[]>;
    getSectionOptions(classId?: string): Promise<{
        label: string;
        value: string;
    }[]>;
    searchStudents(searchTerm: string): Promise<any[]>;
    getStudentById(studentId: string, academicYearId?: string): Promise<{
        account: {
            id: string;
            name: string;
            rollNo: string;
    ...
    createInvoice(opportunityId: string, studentId: string, selectedItems: {
        oliId: string;
        productId: string;
        amount: number;
    }[], paymentMethod: string, bankDetails?: any): Promise<string>;
    getRecentInvoices(studentId?: string): Promise<{
        id: any;
        name: any;
        rollNo: any;
        dateStr: any;
    ...
    voidInvoice(invoiceId: string): Promise<{
        id: string;
        tenantId: string;
    ...
    updateBulkLineItemDiscounts(oliIds: string[], discountPercent: number): Promise<import(".prisma/client").Prisma.BatchPayload>;
    ...
    generateReceiptPdfStream(data: any, res: any): Promise<void>;
    importStudentsBulk(studentDataList: any[]): Promise<{
        totalRows: number;
        successCount: number;
        errors: string[];
    }>;
    createFeeProducts(productNames: string[]): Promise<any[]>;
    getAllFeeProducts(): Promise<{
        id: string;
        isActive: boolean;
        updatedAt: Date;
        name: string;
    ...
    syncPriceBookToStudents(classId: string, academicYearId: string, tx?: any): Promise<void>;
    checkCorrespondentAccess(userId: string, tenantId: string): Promise<boolean>;
    getFinancialCommandCenterData(tenantId: string, filters: any): Promise<{
