...
let AuthController = class AuthController {
    ...
    async verifyOtp(phone, otpCode, portal, generateCode) {
        if (!phone || !otpCode) {
            throw new common_1.BadRequestException('Phone number and OTP code are required');
        }
    ...
    async login(body) {
        ...
        if (targetPortal === 'PLATFORM' && user.role !== client_1.Role.SUPER_ADMIN) {
            throw new common_1.ForbiddenException('Your account belongs to the School Portal. Please use https://app.edutrack.com (http://localhost:3000).');
        }
        if (targetPortal === 'SCHOOL' && user.role === client_1.Role.SUPER_ADMIN) {
            throw new common_1.ForbiddenException('Your account belongs to the Platform Portal. Please use https://platform.edutrack.com (http://localhost:3002).');
        }
...
__decorate([
    ...
    __param(1, (0, common_1.Body)('portal')),
...
__decorate([
    ...
    __param(2, (0, common_1.Body)('portal')),
    __param(3, (0, common_1.Body)('generateCode')),
    __metadata("design:type", Function),
