...
const role_filter_helper_1 = require("./role-filter.helper");
...
exports.ActivityLogModule = ActivityLogModule = __decorate([
    (0, common_1.Global)(),
    (0, common_1.Module)({
        providers: [activity_log_service_1.ActivityLogService, role_filter_helper_1.RoleFilterHelper, prisma_service_1.PrismaService],
        controllers: [activity_log_controller_1.ActivityLogController],
        exports: [activity_log_service_1.ActivityLogService, role_filter_helper_1.RoleFilterHelper],
    })
], ActivityLogModule);
